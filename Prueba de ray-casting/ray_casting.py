...
height_map_img = pg.image.load('Prueba de ray-casting/img/Heightmap.png')
height_map = pg.surfarray.array3d(height_map_img)

color_map_img = pg.image.load('Prueba de ray-casting/img/yes.png')
